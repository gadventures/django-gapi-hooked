...
[![Build Status](https://travis-ci.org/gadventures/django-gapi-hooked.svg?branch=master)](https://travis-ci.org/gadventures/django-gapi-hooked)
...
First, install django-gapi-hooked into your environment.
    ...
    pip install -e git+git@github.com:gadventures/django-gapi-hooked.git@0.4.1#egg=django-gapi-hooked
